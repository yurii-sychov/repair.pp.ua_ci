			...
			<div class="card-body">
				<div class="card-header mb-2 text-center">
					<h5>
						...
						<span class="badge rounded-pill bg-info"><?php echo count($subdivision_srm); ?></span>
					</h5>
				</div>
				<div class="col-lg-12">
					<div class="row row-cols-1 row-cols-md-2 g-1" id="containerScrollbar_2" style="display:none;<?php echo count($subdivision_srm) <= 8 ? 'height:170px' : 'height:420px'; ?>">
						<?php foreach ($subdivision_srm as $subdivision) : ?>
							<div class="col">
								<div class="card">
									<div class="card-body">
										<p class="card-title text-center">
											<a href="/capital_repairs_transformers/sdzp/<?php echo $subdivision->id; ?>" class="btn shadow-none"><?php echo $subdivision->name; ?></a>
										</p>
									</div>
								</div>
							</div>
