										...
										<tbody>
											...
											<?php foreach ($item->operating_data as $data) : ?>
												<tr>
													...
													<td class="text-center">
														<a href="" class="mx-1" data-bs-toggle="tooltip" title="Правити"><i class="bi bi-pencil text-success"></i></a>
														<a href="" class="mx-1" data-bs-toggle="tooltip" title="Завантажити скан акту"><i class="bi bi-image-fill text-danger"></i></a>
													</td>
												</tr>
												<?php $y++; ?>
											<?php endforeach; ?>
